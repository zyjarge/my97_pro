...
My97DP.prototype = {
    init: function () {
        ...
        this.s_startDate = undefined;
        this.s_endDate = undefined;
        $ny = 0;
        $dp.cal = this;
...
//在点击按钮后，设置开始日期
function setStartDate(yy, mm, dd) {
    this.keydown_flag = true;
    this.startDate = new Date(yy + "-" + mm + "-" + dd);
}
...
function getIntervalDates(startDate, stopDate) {
