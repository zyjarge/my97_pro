...
(function() {
  ...
  function B() {
    ...
    var A = {win: Y, $: function($) {return(typeof $ == "string") ? Y[N].getElementById($) : $}, $D: function($, _) {return this.$DV(this.$($).value, _)}, $DV: function(_, $) {
      if(_ != "") {
    ...
    }, hide     : function() {P(this.dd, "none")}, attachEvent: E};
  ...
  function U(K, C) {
    ...
    if(C) {
      ...
      if(!L.el || L.el["My97Mark"] === true || L.el.disabled || ($dp.dd && P($dp.dd) != "none" && $dp.dd.style.left != "-970px")) {
        try {if(L.el["My97Mark"])L.el["My97Mark"] = false} catch(A) {}
        return
      }
  ...
  function P(_, $) {if(_)if($ != null)_.style.display = $; else return R(_, "display")}
  ...
  function I(G, _) {
    ...
    function E(I, H) {
      ...
      try {F = I.lastChild.contentWindow[N]} catch(D) {
        E = true;
